...
namespace DownTracker.Views
{
    public partial class MainForm : Form
    {
        ...
        private void SetupKPISummaryPanel()
        {
            ...
            // Remove any existing ToolStripControlHost, lblDesignerSignature or lblSpringSpacer items to prevent duplicates
            for (int i = statusStrip.Items.Count - 1; i >= 0; i--)
            {
                if (statusStrip.Items[i] is ToolStripControlHost || 
                    statusStrip.Items[i].Name == "lblDesignerSignature" || 
